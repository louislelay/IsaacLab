...
# Pre-defined configs
##
from omni.isaac.lab_assets import BDX_CFG  # isort: skip


@configclass
class BDXRewardsCfg(RewardsCfg):
    ...
    track_ang_vel_z_exp = RewTerm(
        func=mdp.track_ang_vel_z_world_exp, weight=2.0, params={"command_name": "base_velocity", "std": 0.3}
    )
...
class BDXFlatEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    rewards: BDXRewardsCfg = BDXRewardsCfg()
